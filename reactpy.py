...
try:
    ...
    print(e)
countries = ["USA", "Canada", "UK", "Australia", "Germany", "France","srilanka","india","brazile"]
@component
def MyCrud():
    ## Creating state
    alltodo = use_state([])
    ...
    selected_country, set_selected_country = use_state("")
    
    def mysubmit(MyCrud):
        newtodo = {"first_name": first_name,"Last_name":Last_name,"Username":Username,"gender": gender,  
            "phone": phone,"Email":Email,"password": password, "country":selected_country}
    ...
    return html.div(
      ...
      {"style": 
         {"display": "flex",
                ...
                "background-image": "url(https://c4.wallpaperflare.com/wallpaper/176/299/618/river-between-grassfield-with-mountain-background-wallpaper-preview.jpg)", 
      ...
      html.b(html.h1(
                    {"style": {"font-family": "Arial", "font-size": "40px", "justify_content": "center","color":"Violet"}}
         ...
         html.img(
        {
         ...
         "alt": "picture",}),
                    ...
                    html.b(html.h2(
                    {"style": {"font-family": "Arial", "font-size": "20px","color":"Dark blue"}}
                    ,'Sign-Up With Us')),
        ...
        html.select(
            {
                "on_change": lambda event: set_selected_country(event["target"]["value"]),
                "value": selected_country,
            },
            [
                html.option({"value": "", "disabled": True}, "Select a country"),
                *[html.option({"value": country}, country) for country in countries],
            ],
        ),
        html.br(),
    ...
    # add a button
                ...
                {
                    "type": "Reset",
                    "on_click":lambda event: set_first_name("") and set_Last_name("") and set_Username("")and set_gender("") and set_phone("") and set_Email("") and set_password(0) and set_selected_country("")
                },
                "Reset",
                ),
                ),
...
def login(
    ...
    document = {"first_name": first_name,"Last_name":Last_name,"Username":Username,"gender": gender,
        "phone": phone,"Email":Email,"password": password,"country":country}
